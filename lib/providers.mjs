...
export function buildRequest(p, opts) {
  ...
  switch (p.apiStyle) {
    case "anthropic": {
      ...
      body = { model, system: system || undefined, messages: rest, max_tokens: maxTokens, temperature, stream };
    ...
    case "azure": {
      ...
      body = { messages, temperature, max_tokens: maxTokens, stream, ...(json ? { response_format: { type: "json_object" } } : {}) };
      break;
    }
    case "mock": {
      url = "local://mock";
    ...
    default: { // openai
      ...
      body = {
        ...
        temperature, stream,
        ...(p.maxTokensField === "max_completion_tokens" ? { max_completion_tokens: maxTokens } : { max_tokens: maxTokens }),
        ...(json ? { response_format: { type: "json_object" } } : {}),
      };
      break;
    }
